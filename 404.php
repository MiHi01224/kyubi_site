...
<main id="top" class="main">
    <section class="page-404 pagehead">
        <div class="page-404__inner">
            <div class="page-404__content">
                <h2 class="page-404__title">お探しのページが見つかりません。</h2>
                <p class="page-404__text">お客様がアクセスしたページはアドレスが変更されたか、削除された可能性があります。</p>
                <ul class="page-404__list sns">
            ...
            ?>
                    ...
                    <div class="page-404__post card">
                        <p class="card__title">おすすめイラスト</p>
                        <a class="page-404__pic card__image" href="<?php the_permalink(); ?>">
                            <img src="<?php echo catch_that_image(); ?>" alt="<?php the_title(); ?>" />
                        </a>
                        <a class="card__text" href="<?php the_permalink(); ?>">
                            <p><?php the_title(); ?></p>
                        </a>
                    </div>
