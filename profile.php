...
<main id="top" class="main">
    ...
    <section class="profile">
        <div class="profile__inner">
            <h2 class="profile__title"><img src="./image/title_profile.svg" alt="プロフィール"></h2>
            <div class="profile__content">
                <img class="profile__pic" src="./image/illustration/pic_top2.png" alt="">
                <div class="profile__outer unit">
                    <h3 class="unit__title">九尾みか</h3>
                    <p class="unit__text">個人サークル名:PRIMARYS</p>
                    <p class="unit__text">
                        <span>可愛い女の子を描くのが好きです。繊細でキラキラしたイラストが得意です。</span>
                        <span>いつかオリジナルのイラスト本が出せたらいいなと思っております。</span>
                    </p>
                    <ul class="profile__list sns">
                        <li class="sns__item"><a href="https://x.com/primarys2020" target=”_blank”><img class="sns__pic" src="./image/iconX.svg" alt="キュウビミカのエックスに移動"></a></li>
                        <li class="sns__item"><a href="https://www.pixiv.net/users/3905543" target=”_blank”><img class="sns__pic" src="./image/iconPixiv.png" alt="キュウビミカのピクシブに移動"></a></li>
                        <li class="sns__item"><a href="https://bsky.app/profile/primarys2020.bsky.social" target=”_blank”><img class="sns__pic" src="./image/iconBluesky.png" alt="キュウビミカのブルースカイに移動"></a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section class="contact">
        <div class="contact__inner">
            <h2 class="contact__title"><img src="./image/title_contact.svg" alt="コンタクト"></h2>
