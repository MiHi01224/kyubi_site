...
<main id="top" class="main">
    <section class="work pagehead">
        <div class="work__inner">
            <h2 class="work__title"><img src="<?php echo get_theme_file_uri('./image/title_work.svg'); ?>" alt="制作実績"></h2>
            <p class="work__text">
                <?php if (is_category()) : ?>
                    「<?php single_cat_title(); ?>」の作品一覧
                <?php elseif (is_tag()) : ?>
                    #<?php single_tag_title(); ?> の作品一覧
                <?php elseif (is_date()) : ?>
                    「<?php echo get_the_date('Y年n月'); ?>」に投稿された作品一覧
                <?php else: ?>
                    「<?php the_archive_title(); ?>」に関する作品一覧
                <?php endif; ?>
            </p>
            <article class="work__list">
                ...
                ?>
                        ...
                        <div class="work__item card <?php $posttags = get_the_tags();
                                                    if ($posttags) {
                            ...
                            <a href="<?php the_permalink(); ?>">
                                <img class="card__image" src="<?php echo catch_that_image(); ?>" alt="<?php the_title(); ?>" />
                                <p class="card__title"><?php the_title(); ?></p>
                                <p class="card__text"><?php echo get_the_tag_list('', ' , '); ?></p>
                            </a>
                        </div>
